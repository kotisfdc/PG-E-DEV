({
    ...
    */
    ...
    handleMenuSelect: function(cmp, event, helper) {
        ...
        cmp.set("v.DashboardName",selectedMenuItemValue);
        var appEvent = $A.get("e.c:appEventOnSelect");
        var selectedString = cmp.get("v.DashboardName");
        //console.log('===selectedString===>',selectedString);
        appEvent.setParams({ "message" : selectedString });
        appEvent.fire();      
    },
