({
    ...
    getDashboardViews : function(component, event, helper){
        ...
        var appName = component.get("v.messageFromEvent");
        console.log('===HelperappName===>',appName);
        action.setParams({
    ...
    refreshJOBFinal : function (component, event, helper,typeAction){
        ...
        helper.globalCompEvent(component, event, helper, component.get('v.loggedInContact'), component.get("v.selectedJobOwnerId"), component.get("v.userConfigRec"), appName);        
    },
    globalCompEvent : function(component, event, helper, loggedInContact, jobOwnerIds, dashboardId, appName){  
        debugger;       
        var evnt = $A.get('e.c:GlobalFilterEvent');
        var appName = component.get("v.messageFromEvent");
        console.log('AppName in Event Fire====>',appName);
        if(appName != null)
        {
        evnt.setParams({
    ...
    openDashBoardModel : function(component, event, helper){
        ...
        $A.createComponent(
            "c:Dashboard_Config",
            {
                ...
                'appName' : component.get("v.messageFromEvent")
